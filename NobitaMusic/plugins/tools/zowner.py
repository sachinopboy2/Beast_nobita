...
from NobitaMusic.mongo.afkdb import LOGGERS as OWNERS
from NobitaMusic.utils.database import add_served_chat, get_assistant
            ...
            [
                [
                    InlineKeyboardButton(
                        "🍁 sᴏᴜʀᴄᴇ 🍁", url=f"https://t.me/COOL_NOBITA"
                    )
                ]
            ]
        ),
