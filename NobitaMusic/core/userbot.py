    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("SexyChampu")
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("SexyChampu")
                await self.two.join_chat("ShivanshuHUB")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("SexyChampu")
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("SexyChampu")
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("SexyChampu")
